...
public sealed class CliTabView : View
{
    ...
    private readonly Button _browserMenu;
        ...
        CliTabSession session)
    {
        ...
        _browserMenu = MenuButton("Browser", 0, "All");
        _categoryMenus = new[]
        {
        ...
        {
            Text = "This browser needs a terminal of at least 48 columns by 12 rows.\nResize the terminal to continue.",
            X = 1,
            Y = 2,
            Width = Dim.Fill(2),
            Height = Dim.Fill(2),
    ...
    private void ApplyResponsiveLayout()
    {
        ...
        _browserMenu.Visible = !categoryMenus;
    ...
    private void StackStartPage(Int32 width, Int32 scroll, String focus)
    {
        ...
        {
            Text = Session.Address is null ? "LUMUI" : Session.Title.ToUpperInvariant(),
            X = 0,
            Y = 0,
            Width = width,
            Height = 1,
