...
public static class TerminalMediaService
{
    ...
    private static String ResolveFfmpeg()
    {
        ...
        String? configured = Environment.GetEnvironmentVariable("LUMI_FFMPEG_PATH");
        ...
        return candidates.FirstOrDefault(File.Exists)
            ?? throw new FileNotFoundException("The bundled Lumi media decoder was not found.");
    }
    ...
    private static HttpClient CreateClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.ParseAdd("Lumi-CLI/1.0");
        return client;
    }
